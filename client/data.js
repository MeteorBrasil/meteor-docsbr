...
DocsData = {
  ...
  "Accounts.config": {
    ...
    "options": [
      ...
      {
        "description": "<p>Calls to <a href=\"#accounts_createuser\"><code>createUser</code></a> from the Cliente will be rejected. In addition, if you are using <a href=\"#accountsui\">accounts-ui</a>, the &quot;Create account&quot; link will not be available.</p>",
        "name": "forbidClienteAccountCreation",
        "type": {
          "names": [
            "Boolean"
          ]
      ...
      {
        "description": "<p>When using the <code>oauth-encryption</code> package, the 16 byte key using to encrypt sensitive account credentials in the database, encoded in base64.  This option may only be specifed on the Servidor.  See packages/oauth-encryption/README.md for details.</p>",
        "name": "oauthSecretKey",
        "type": {
          "names": [
            "String"
  ...
  "Accounts.createUser": {
    ...
    "params": [
      ...
      {
        "description": "<p>Cliente only, optional callback. Called with no arguments on success, or with a single <code>Error</code> argument on failure.</p>",
        "name": "callback",
        "optional": true,
        "type": {
          "names": [
  ...
  "Assets.getBinary": {
    ...
    "scope": "static",
    "summary": "Retrieve the contents of the static Servidor asset as an [EJSON Binary](#ejson_new_binary)."
  },
  "Assets.getText": {
    "kind": "function",
    "locus": "Servidor",
    ...
    "scope": "static",
    "summary": "Retrieve the contents of the static Servidor asset as a UTF8-encoded string."
  },
  "Blaze": {
    "kind": "namespace",
    "longname": "Blaze",
  ...
  "DDP.connect": {
    ...
    "scope": "static",
    "summary": "Connect to the Servidor of a different Meteor application to subscribe to its document sets and invoke its remote methods."
  },
  "EJSON": {
    "kind": "namespace",
    "longname": "EJSON",
  ...
  "Email.send": {
    ...
    "scope": "static",
    "summary": "Send an email. Throws an `Error` on failure to contact mail Servidor\nor if mail Servidor returns an error. All fields should match\n[RFC5322](http://tools.ietf.org/html/rfc5322) specification."
  },
  "HTTP.call": {
    "kind": "function",
    "locus": "Qualquer lugar",
    ...
    "options": [
      ...
      {
        "description": "<p>If <code>true</code>, transparently follow HTTP redirects. Cannot be set to <code>false</code> on the Cliente. Default <code>true</code>.</p>",
    ...
    "params": [
      ...
      {
        "description": "<p>Optional callback.  If passed, the method runs asynchronously, instead of synchronously, and calls asyncCallback.  On the Cliente, this callback is required.</p>",
        "name": "asyncCallback",
        "optional": true,
        "type": {
          "names": [
  ...
  "HTTP.del": {
    ...
    "params": [
      ...
      {
        "description": "<p>Callback that is called when the request is completed. Required on the Cliente.</p>",
        "name": "asyncCallback",
        "optional": true,
        "type": {
          "names": [
  ...
  "Meteor.absoluteUrl": {
    ...
    "options": [
      ...
      {
        "description": "<p>Override the default ROOT_URL from the Servidor environment. For example: &quot;<code>http://foo.example.com</code>&quot;</p>",
        "name": "rootUrl",
        "type": {
          "names": [
            "String"
    ...
    "scope": "static",
    "summary": "Generate an absolute URL pointing to the application. The Servidor reads from the `ROOT_URL` environment variable to determine where it is running. This is taken care of automatically for apps deployed with `meteor deploy`, but must be provided when using `meteor build`."
  },
  "Meteor.apply": {
    "kind": "function",
    "locus": "Qualquer lugar",
    ...
    "options": [
      {
        "description": "<p>(Cliente only) If true, don't send this method until all previous method calls have completed, and don't send any subsequent method calls until this one is completed.</p>",
        "name": "wait",
        "type": {
          "names": [
            "Boolean"
      ...
      {
        "description": "<p>(Cliente only) This callback is invoked with the error or result of the method (just like <code>asyncCallback</code>) as soon as the error or result is available. The local cache may not yet reflect the writes performed by the method.</p>",
  ...
  "Meteor.disconnect": {
    ...
    "params": [],
    "scope": "static",
    "summary": "Disconnect the Cliente from the Servidor."
  },
  "Meteor.isCliente": {
    "kind": "member",
    "locus": "Qualquer lugar",
    "longname": "Meteor.isCliente",
    "memberof": "Meteor",
    "name": "isCliente",
    "scope": "static",
    "summary": "Boolean variable.  True if running in Cliente environment.",
    "type": {
      "names": [
        "Boolean"
      ]
  ...
  "Meteor.isServidor": {
    "kind": "member",
    "locus": "Qualquer lugar",
    "longname": "Meteor.isServidor",
    "memberof": "Meteor",
    "name": "isServidor",
    "scope": "static",
    "summary": "Boolean variable.  True if running in Servidor environment.",
    "type": {
      "names": [
        "Boolean"
      ]
  ...
  "Meteor.logoutOtherClientes": {
    "kind": "function",
    "locus": "Cliente",
    "longname": "Meteor.logoutOtherClientes",
    "memberof": "Meteor",
    "name": "logoutOtherClientes",
    "options": [],
    "params": [
      {
        "description": "<p>Optional callback. Called with no arguments on success, or with a single <code>Error</code> argument on failure.</p>",
    ...
    "scope": "static",
    "summary": "Log out other Clientes logged in as the current user, but does not log out the Cliente that calls this function."
  },
  "Meteor.methods": {
    "kind": "function",
    "locus": "Qualquer lugar",
    ...
    "scope": "static",
    "summary": "Defines functions that can be invoked over the network by Clientes."
  },
  "Meteor.onConnection": {
    "kind": "function",
    "locus": "Servidor",
    ...
    "scope": "static",
    "summary": "Register a callback to be called when a new DDP connection is made to the Servidor."
  },
  "Meteor.publish": {
    "kind": "function",
    "locus": "Servidor",
    ...
    "params": [
      {
        "description": "<p>Name of the record set.  If <code>null</code>, the set has no name, and the record set is automatically sent to all connected Clientes.</p>",
        "name": "name",
        "type": {
          "names": [
            "String"
      ...
      {
        "description": "<p>Function called on the Servidor each time a Cliente subscribes.  Inside the function, <code>this</code> is the publish handler object, described below.  If the Cliente passed arguments to <code>subscribe</code>, the function is called with the same arguments.</p>",
        "name": "func",
        "type": {
          "names": [
            "function"
  ...
  "Meteor.reconnect": {
    ...
    "params": [],
    "scope": "static",
    "summary": "Force an immediate reconnection attempt if the Cliente is not connected to the Servidor.\n\n  This method does nothing if the Cliente is already connected."
  },
  "Meteor.release": {
    "kind": "member",
    "locus": "Qualquer lugar",
  ...
  "Meteor.settings": {
    ...
    "name": "settings",
    "scope": "static",
    "summary": "`Meteor.settings` contains deployment-specific configuration options. You can initialize settings by passing the `--settings` option (which takes the name of a file containing JSON data) to `meteor run` or `meteor deploy`. When running your Servidor directly (e.g. from a bundle), you instead specify settings by putting the JSON directly into the `METEOR_SETTINGS` environment variable. If you don't provide any settings, `Meteor.settings` will be an empty object.  If the settings object contains a key named `public`, then `Meteor.settings.public` will be available on the Cliente as well as the Servidor.  All other properties of `Meteor.settings` are only defined on the Servidor.",
    "type": {
      "names": [
        "Object"
      ]
  ...
  "Meteor.startup": {
    ...
    "scope": "static",
    "summary": "Run code when a Cliente or a Servidor starts."
  },
  "Meteor.status": {
    "kind": "function",
    "locus": "Cliente",
  ...
  "Meteor.user": {
    "kind": "function",
    "locus": "Qualquer lugar but publish functions",
  ...
  "Meteor.wrapAsync": {
    ...
    "scope": "static",
    "summary": "Wrap a function that takes a callback function as its final parameter. On the Servidor, the wrapped function can be used either synchronously (without passing a callback) or asynchronously (when a callback is passed). On the Cliente, a callback is always required; errors will be logged if there is no callback. If a callback is provided, the environment captured when the original function was called will be restored in the callback."
  },
  "MethodInvocation": {
    "instancename": "this",
    "kind": "function",
  ...
  "MethodInvocation#connection": {
    ...
    "name": "connection",
    "scope": "instance",
    "summary": "Access inside a method invocation. The [connection](#meteor_onconnection) that this method was received on. `null` if the method is not associated with a connection, eg. a Servidor initiated method call."
  },
  ...
  "MethodInvocation#unblock": {
    ...
    "params": [],
    "scope": "instance",
    "summary": "Call inside a method invocation.  Allow subsequent method from this Cliente to begin running in a new fiber."
  },
  ...
  "Mongo.Collection": {
    ...
    "options": [
      {
        "description": "<p>The Servidor connection that will manage this collection. Uses the default connection if not specified.  Pass the return value of calling <a href=\"#ddp_connect\"><code>DDP.connect</code></a> to specify a different Servidor. Pass <code>null</code> to specify no connection. Unmanaged (<code>name</code> is null) collections cannot specify a connection.</p>",
        "name": "connection",
        "type": {
          "names": [
            "Object"
  ...
  "Mongo.Collection#allow": {
    ...
    "scope": "instance",
    "summary": "Allow users to write directly to this collection from Cliente code, subject to limitations you define."
  },
  ...
  "Mongo.Collection#find": {
    ...
    "options": [
      ...
      {
        "description": "<p>(Cliente only) Default <code>true</code>; pass <code>false</code> to disable reactivity</p>",
        "name": "reactive",
        "type": {
          "names": [
            "Boolean"
  ...
  "Mongo.Collection#findOne": {
    ...
    "options": [
      ...
      {
        "description": "<p>(Cliente only) Default true; pass false to disable reactivity</p>",
        "name": "reactive",
        "type": {
          "names": [
            "Boolean"
  ...
  "PackageAPI#addFiles": {
    ...
    "params": [
      ...
      {
        "description": "<p>If you only want to export the file\non the Servidor (or the Cliente), you can pass in the second argument\n(e.g., 'Servidor', 'Cliente', 'web.browser', 'web.cordova') to specify\nwhat architecture the file is used with.</p>",
        "name": "architecture",
        "optional": true,
        "type": {
          "names": [
  ...
  "PackageAPI#use": {
    ...
    "params": [
      ...
      {
        "description": "<p>If you only use the package on the\nServidor (or the Cliente), you can pass in the second argument (e.g.,\n<code>'Servidor'</code>, <code>'Cliente'</code>, <code>'web.browser'</code>, <code>'web.cordova'</code>) to specify\nwhat architecture the package is used with.</p>",
        "name": "architecture",
        "optional": true,
        "type": {
          "names": [
  ...
  "Subscription": {
    ...
    "options": [],
    "params": [],
    "summary": "The Servidor's side of a subscription"
  },
  "Subscription#added": {
    "kind": "function",
    "locus": "Servidor",
  ...
  "Subscription#error": {
    ...
    "params": [
      {
        "description": "<p>The error to pass to the Cliente.</p>",
        "name": "error",
        "type": {
          "names": [
            "Error"
    ...
    "scope": "instance",
    "summary": "Call inside the publish function.  Stops this Cliente's subscription, triggering a call on the Cliente to the `onError` callback passed to [`Meteor.subscribe`](#meteor_subscribe), if any. If `error` is not a [`Meteor.Error`](#meteor_error), it will be [sanitized](#meteor_error)."
  },
  "Subscription#onStop": {
    "kind": "function",
    "locus": "Servidor",
  ...
  "Subscription#ready": {
    ...
    "params": [],
    "scope": "instance",
    "summary": "Call inside the publish function.  Informs the subscriber that an initial, complete snapshot of the record set has been sent.  This will trigger a call on the Cliente to the `onReady` callback passed to  [`Meteor.subscribe`](#meteor_subscribe), if any."
  },
  ...
  "Subscription#stop": {
    ...
    "params": [],
    "scope": "instance",
    "summary": "Call inside the publish function.  Stops this Cliente's subscription; the `onError` callback is *not* invoked on the Cliente."
  },
  "Subscription#userId": {
    "kind": "member",
    "locus": "Servidor",
