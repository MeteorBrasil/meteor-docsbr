...
var toc = [
  {name: "Meteor " + Template.headline.release(), id: "top"}, [
    {name: "Começo Rápido", id: "quickstart"},
    {name: "Sete principios", id: "sevenprinciples"},
    {name: "Recursos", id: "resources"},
  ],
  {name: "Conceitos", id: "concepts"}, [
    {name: "O que é Meteor?", id: "whatismeteor"},
    {name: "Estruturando sua app", id: "structuringyourapp"},
    {name: "Dados e segurança", id: "dataandsecurity"},
    {name: "Reatividade", id: "reactivity"},
    {name: "Live HTML", id: "livehtml"},
    {name: "Templates", id: "templates"},
    {name: "Usando pacotes", id: "usingpackages"},
    {name: "Namespacing", id: "namespacing"},
    {name: "Deploying", id: "deploying"},
    {name: "Criando pacotes", id: "writingpackages"},
  ],

  "API", [
    {name: "Principal", id: "core"}, [
      "Meteor.isClient",
      "Meteor.isServer",
      "Meteor.startup",
      "Meteor.absoluteUrl",
    ...
    {name: "Publicação e subscrição", id: "publishandsubscribe"}, [
      "Meteor.publish", [
    ...
    {name: "Métodos", id: "methods_header"}, [
      "Meteor.methods", [
    ...
    {name: "Conexões com o servidor", id: "connections"}, [
      "Meteor.status",
      "Meteor.reconnect",
      "Meteor.disconnect",
      "Meteor.onConnection",
    ...
    {name: "Senhas", id: "accounts_passwords"}, [
      "Accounts.createUser",
  ...
  {name: "Pacotes Oficiais", id: "packages"}, [ [
    "accounts-ui",
    "amplify",
    "appcache",
  ...
  {name: "Linha de comando", id: "commandline"}, [ [
    "meteor help",
    "meteor run",
    "meteor create",
    "meteor deploy",
